...
for ZERO_DAY in ZERO_DAY_LIST:
    ...
    # =====================================================
    # ✅ UPDATED PAPER GATING LOGIC
    # =====================================================

    HIGH_THRESHOLD = np.percentile(residual_memory, 95)
    LOW_THRESHOLD  = np.percentile(residual_memory, 90)
    ...
    for i in range(len(X_eval)):
        ...
        if residual > HIGH_THRESHOLD:

            final_pred = "ZERO_DAY"

        elif residual > LOW_THRESHOLD:
