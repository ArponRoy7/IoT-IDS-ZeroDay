# =========================================================
# HYBRID LOAO – THREE-ZONE GATEKEEPER (FULL SCRIPT)
# High / Medium / Low Residual Logic
# =========================================================
...
print("DAE Threshold (95%):", threshold)
...
high_threshold = threshold * 2.0

hybrid_preds = []

for i in range(len(X_eval)):

    if residual_eval[i] > high_threshold:
        # Extreme anomaly
        hybrid_preds.append("ZERO_DAY")

    elif residual_eval[i] > low_threshold:
        # Medium anomaly → consult RF
...
print("\nThree-Zone Gatekeeper Evaluation Completed.")