# =========================================================
# FULL UTILIZATION – DUAL RESIDUAL ADAPTIVE HYBRID
# Same as FULL baseline but with Temporal Variance Feature
# =========================================================
...
for ZERO_DAY in ZERO_DAY_LIST:
    ...
    print("Training DAE FULL (Dual Residual)...")
    ...
    # =====================================================
    # RF TRAIN FULL DATASET (Dual Feature)
    # =====================================================

    print("Training RF FULL dataset (Dual Residual)")
    ...
    print("RF trained FULL (Dual Residual)")
    ...
    # ---- Same variance feature for eval ----
...
print("\nFULL UTILIZATION DUAL-RESIDUAL COMPLETED")