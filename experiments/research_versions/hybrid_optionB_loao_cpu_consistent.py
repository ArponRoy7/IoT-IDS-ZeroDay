# =========================================================
# OPTION B - LOAO HYBRID (CPU CONSISTENT VERSION)
# FIXED ATTACK LIST
# 3 RUNS EACH + MEAN + STD
# NO SKIPPING
# RF SAMPLE = 500K (CONSISTENT)
# =========================================================
...
for ZERO_DAY in ATTACKS:
    ...
    for run in range(3):
        ...
        # =====================================================
        # RANDOM FOREST (FIXED 500K SAMPLE)
        # =====================================================

        rf_sample = train_df.sample(
            min(500000, len(train_df)),
            random_state=seed
        )
