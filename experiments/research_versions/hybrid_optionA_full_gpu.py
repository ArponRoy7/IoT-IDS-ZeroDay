# =========================================================
# HYBRID LOAO STRICT FULL GPU V2
# Deep Autoencoder + Stratified RF
...
for ZERO_DAY in ATTACKS:
    ...
    # =====================================================
    # STRATIFIED RF TRAINING (FIXED VERSION)
    # =====================================================
    print("Preparing stratified RF sample...")
    ...
    # =====================================================
    eval_df = pd.concat([
        train_df.sample(100000, random_state=42),
        test_zero_df.sample(min(10000, len(test_zero_df)), random_state=42)
    ])
    ...
    zero_detected = (final_preds[y_eval == ZERO_DAY] == "ZERO_DAY").mean()
