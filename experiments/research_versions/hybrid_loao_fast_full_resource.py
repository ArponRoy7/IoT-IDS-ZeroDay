# =========================================================
# HYBRID LOAO – ADAPTIVE SLIDING WINDOW (FAST LOGIC)
# FULL DATASET VERSION – NO SAMPLING
# 95th Percentile | Alpha 0.995 | RF 0.85
# =========================================================
...
for ZERO_DAY in ZERO_DAY_LIST:
    ...
    print("\n" + "="*80)
    print(f"FULL RESOURCE ZERO-DAY TEST: {ZERO_DAY}")
    print("="*80)
    ...
    loader = DataLoader(
        ...
        batch_size=8192,   # larger batch for GPU utilization
        shuffle=True
    )
    ...
    # =====================================================
    # SLIDING WINDOW MEMORY (FULL BENIGN)
    # =====================================================
    ...
    with torch.no_grad():
        for (x,) in loader:
            ...
            residual_memory.extend(residual_batch)

    print("Sliding window initialized.")

    # =====================================================
    # RF TRAINING ON FULL DATA
    # =====================================================
...
print("\n" + "="*80)
print("FINAL SUMMARY TABLE (FULL RESOURCE)")
print("="*80)
