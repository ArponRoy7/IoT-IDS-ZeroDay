# =========================================================
# HYPER-TUNED HYBRID LOAO – VARIANCE-ADAPTIVE THRESHOLD
# ALL ATTACKS VERSION + FINAL SUMMARY TABLE
# Window=30000 | Variance Adaptive Percentile | Alpha=0.999
# =========================================================
...
print("Variance Switch:", VARIANCE_SWITCH)
...
for ZERO_DAY in ZERO_DAY_LIST:
    ...
    for i in range(len(X_eval)):
        ...
        residual_array = np.array(residual_memory)

        variance = np.var(residual_array)

        if variance > VARIANCE_SWITCH:
        ...
        threshold = np.percentile(residual_array, adaptive_percentile)
