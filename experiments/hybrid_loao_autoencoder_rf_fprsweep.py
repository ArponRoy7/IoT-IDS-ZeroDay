...
# =========================================================
# CASCADED HYBRID (FPR SWEEP)
# =========================================================
print("\n========================================")
print("TWO-THRESHOLD CASCADED HYBRID (FPR SWEEP)")
print("========================================")

fpr_values = np.linspace(0.005, 0.04, 8)  # 0.5% → 4%
...
for fpr_target in fpr_values:
    ...
    summary_results.append(
        (fpr_target, zero_rate, benign_recall, acc)
    )

    print(f"\nFPR Target: {fpr_target*100:.2f}%")
